...
fun BottomSheetMealDetailMenu(content: @Composable (ModalBottomSheetState, () -> Unit) -> Unit,
    ...
    ModalBottomSheetLayout(
        ...
        sheetContent = {
            BottomSheetMealDetailMenuContent(mealsViewModel = mealsViewModel, recipeId = mealId, scope, navController, dialogOpen, modalSheetState,  mealDetail)
...
fun BottomSheetMealDetailMenuContent(mealsViewModel: MealsViewModel, recipeId: String, scope: CoroutineScope,
    ...
    DeleteRecipeAlertDialog(dialogOpen = dialogOpen, navController = navController, mealsViewModel, recipeId)
}
